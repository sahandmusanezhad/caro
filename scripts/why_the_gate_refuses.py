...
def main() -> int:
    ...
    print("  reads as a fact about the baseline's quality, and it is not:")
    print("  under this split the comparables ladder degenerates to global,")
    print("  and that one estimator is scored against trims it has never seen")
    print("  at prices it has never seen. The refusal is real and correct —")
    print("  CARO still may not serve an estimate here — but the number")
    print("  carries no information about how good this baseline is.")
    print("\n  Does NOT establish that no estimator can pass here. What is")
    print("  shown is that comparable- and global-quantiles are one estimator")
    print("  under this split. A model using parent, family, year, mileage or")
    print("  price band might predict the held-out distribution better and")
    print("  cover it better. This baseline degenerating is not evidence that")
    print("  every estimator must — reading it that way turns a diagnostic")
    print("  into an alibi.")
