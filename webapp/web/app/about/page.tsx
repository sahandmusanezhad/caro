...
const FACTS: [string, string, string][] = [
  ['۵۷', 'تصمیم ثبت‌شده', 'docs/DECISIONS.md'],
  ['۱۳۱۴', 'گزاره‌ی آزمون', 'tests/run_all.py'],
  ['۱۳', 'مجموعه‌ی آزمون', 'یکی از آن‌ها فقط مراقب بازگشت ادعاهای بازنشسته است'],
    ...
    <div className="flex flex-col gap-10">
      ...
      <section className="panel">
        ...
        <p className="m-0 text-[15px] leading-[1.95] max-w-[64ch]">
          بیشتر آن ۵۷ تصمیم به این دلیل نوشته شده‌اند که چیزی به‌شکلی نامرئی
