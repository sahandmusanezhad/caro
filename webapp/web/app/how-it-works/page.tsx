...
const LAYERS = [
  ...
  },
  {
    ...
    what: 'همان آگهی در طول زمان دنبال می‌شود: تغییر قیمت، حذف، و انتشار مجدد '
      + 'با شناسه‌ی تازه.',
    detail: 'ناپدیدشدن یک آگهی به‌معنای فروش نیست — ممکن است صاحبش منصرف شده '
      + 'باشد یا آگهی منقضی شده باشد — و این تفاوت، سوگیری سانسور است. '
      + 'آگهی‌های تکراری در یک خوشه جمع می‌شوند تا یک ماشین، چند بار در '
      + 'آموزش شمرده نشود.',
  },
  {
    id: 'W1',
